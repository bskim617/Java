...
class _SalartStudent extends _Student {
	private String company;
	
	public _SalartStudent(String name, int age, String school, String major, String company) {
...
public class Test06 {
	public static void main(String[] args) {
		...
		_SalartStudent lee = new _SalartStudent("이순신", 27, "부산대", "경재학과", "삼성전자");
